...
class EventStrings {
    ...
    static let ADDIT_CONTENT_FAILED = "ADDIT_CONTENT_FAILED"
    static let ADDIT_CONTENT_ITEM_FAILED = "ADDIT_CONTENT_ITEM_FAILED"
    static let NO_ADDIT_CONTENT_LISTENER = "NO_ADDIT_CONTENT_LISTENER"
    static let LISTENER_REGISTRATION_ERROR = "App did not register an AddIt Content listener"

    static let AD_PAYLOAD_IS_EMPTY = "AD_PAYLOAD_IS_EMPTY"
    static let AD_GET_REQUEST_FAILED = "AD_GET_REQUEST_FAILED"
    static let AD_EVENT_TRACK_REQUEST_FAILED = "AD_EVENT_TRACK_REQUEST_FAILED"
    ...
    static let SESSION_RESUMED = "SESSION_RESUMED"
    static let SESSION_BACKGROUNDED = "SESSION_BACKGROUNDED"

    static let KI_INIT_REQUEST_FAILED = "KI_INIT_REQUEST_FAILED"
    static let KI_EVENT_REQUEST_FAILED = "KI_EVENT_REQUEST_FAILED"

    static let USER_ADDED_TO_LIST = "user_added_to_list"
    static let USER_CROSSED_OFF_LIST = "user_crossed_off_list"
    static let USER_DELETED_FROM_LIST = "user_deleted_from_list"

    static let ATL_ITEM_ADDED_TO_LIST = "atl_item_added_to_list"
